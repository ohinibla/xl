...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.switch_find_duplicates.setGeometry(QRect(26, 160, 171, 28))
        font = QFont()
        font.setPointSize(12)
        font.setBold(True)
        self.switch_find_duplicates.setFont(font)
        self.switch_save_files = QCheckBox(self.frame_side)
        self.switch_save_files.setObjectName(u"switch_save_files")
        self.switch_save_files.setGeometry(QRect(26, 200, 171, 28))
        self.switch_save_files.setFont(font)
        ...
        self.btn_find_duplicates.setFont(font)
        self.btn_remove_files = QPushButton(self.frame_side)
        self.btn_remove_files.setObjectName(u"btn_remove_files")
        self.btn_remove_files.setGeometry(QRect(20, 96, 171, 34))
        self.btn_remove_files.setMinimumSize(QSize(84, 0))
        self.btn_remove_files.setMaximumSize(QSize(16777215, 34))
        self.btn_remove_files.setFont(font)
        ...
        self.frame_main_file.setFrameShape(QFrame.NoFrame)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 471, 301))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_remove_files.setText(QCoreApplication.translate("MainWindow", u"Remove Files", None))
